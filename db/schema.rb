...
ActiveRecord::Schema.define(version: 2020_06_13_210859) do
  ...
  create_table "shared_locations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "user_locations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "address"
    t.float "latitude"
    t.float "longitude"
